...
@REM Diferença crucial: mudei stage_channels para [256, 512, 1024, 2048]
REM Não vou mais usar class_weights. corrigi o desbalanceamento com oversampling e weightedRandomSampler
REM mean=[0.387444, 0.208384, 0.132099], std=[0.282517, 0.211356, 0.166142]
REM ============================================================================

echo ============================================================================
echo INICIANDO EXPERIMENTO 8
echo ============================================================================
echo.
...
python main.py ^
    ...
    --save_dir "results_itapecuru_exp_9" ^
    --num_classes 3 ^
    --patience 10 ^
    --min_epochs 25 ^
